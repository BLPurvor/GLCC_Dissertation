...
export default function NewCoupon() {
  ...
  const [fixtures, setFixtures] = useState(Array<Fixture>); // Fixtures array defined through state for conditional hook
  ...
  return (
    <Layout user_id={user_id}>
      <div className={styles.container}>
        ...
        <form id="fixtureSelect" onSubmit={handleCreation}>
          <input
